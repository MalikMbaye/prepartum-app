...
const promptData = [
  ...
  { body: "What prayer, scripture, or spiritual affirmation do you want to return to during labor? Write it or speak it out loud now so it lives in your body before that day.", category: "mindset", context: "Words that are rehearsed before a high-stress moment become anchors during it. Women who enter birth with a chosen phrase or affirmation — spiritual or otherwise — report using it instinctively when things get hard. Plant it now.", closingReframe: "You are not walking into birth alone. You never were.", personaTags: ["faith_anchored"], seasons: ["grounding", "expanding", "mixed"], trimester: 3, depth: "deep", format: "voice", intensity: 2, estimatedEnergy: "medium", relevanceTags: ["spiritual", "values", "meaning"], requiredFlags: null, excludedFlags: null, addressesFear: null },
  ...
  { body: "Have you and your partner talked about how your relationship will change when the baby arrives? Not the logistics — the emotional reality of it?", category: "relationships", context: "Research on postpartum relationship strain shows that the couples who struggle most are often the ones who planned everything except their relationship. The logistics — sleep schedules, feeding plans — are covered. The emotional reality rarely is. This conversation is worth having now.", closingReframe: "Naming what might get hard is not pessimism. It is how you protect what you have built.", personaTags: ["supported_nurturer"], seasons: ["expanding", "mixed"], trimester: 2, depth: "deep", format: "text", intensity: 3, estimatedEnergy: "high", relevanceTags: ["identity_concern"], requiredFlags: null, excludedFlags: ["solo_parenting"], addressesFear: null },
  ...
  { body: "What story about yourself as a mother have you already decided is true before you have even begun? Is that story serving you?", category: "mindset", context: "The stories we tell ourselves before we begin shape what we allow ourselves to become. Many women arrive at motherhood carrying a verdict about themselves — 'I am too anxious', 'I am like my mother', 'I am not maternal' — that was written by someone else. This reflection invites you to examine the verdict before it becomes a self-fulfilling prophecy.", closingReframe: "You have not written this story yet. You are still holding the pen.", personaTags: [], seasons: ["tender", "grounding", "mixed"], trimester: 1, depth: "medium", format: "text", intensity: 2, estimatedEnergy: "medium", relevanceTags: ["identity_concern"], requiredFlags: null, excludedFlags: null, addressesFear: "imposter_fear" },
...
const closingReframesData = [
  ...
  { season: "tender", category: "validation", originalThought: "I'm being too sensitive.", reframedThought: "You're not too sensitive. You're deeply attuned. That sensitivity will make you an incredibly connected mother.", tone: "affirming" },
  ...
  { season: "grounding", category: "empowerment", originalThought: "I need to be stronger.", reframedThought: "You are already stronger than you know. Strength isn't never struggling — it's continuing despite the struggle.", tone: "empowering" },
  ...
  { season: "restorative", category: "growth_mindset", originalThought: "Will I ever feel like myself again?", reframedThought: "You're becoming a new version of yourself — not losing who you were, but expanding into who you're meant to be.", tone: "hopeful" },

  { season: "mixed", category: "self_compassion", originalThought: "I don't know what I'm feeling.", reframedThought: "It's okay to feel many things at once. Complexity is not confusion — it's being fully human.", tone: "gentle" },
  { season: "mixed", category: "validation", originalThought: "My feelings change every day.", reframedThought: "That's not instability — that's your heart making room for the biggest transformation of your life.", tone: "affirming" },
